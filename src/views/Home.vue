  ...
  <main id="conteudo">
    ...
    <!-- <article id="home__knowMore" class="home__knowMore">
      <div class="container" id="donation-wrap">
        ...
        <p>
          <strong>Viabilizar a realização de eventos nas 5 regiões do país, em 17 cidades, para a construção do programa.</strong>
        ...
        <p>
          <strong>Manutenção de plataforma online para participação e mobilização, especialmente os grupos de ação.</strong>
        ...
        <p>
          <strong>Campanha de comunicação.</strong>
        ...
        <p>
          <strong>Sistematização das propostas feitas.</strong>
